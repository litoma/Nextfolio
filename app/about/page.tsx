      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        {phones.map((phone, index) => (
          <li className="overflow-hidden !m-0 ps-0 relative">
            <p className="w-20 float-left mt-1">
              {phone.year}
            </p>
            <div className="float-left border-l-2 border-white pl-1 relative before:content-[''] before:w-1 before:h-1 before:bg-white before:absolute before:left-10 before:top-1 before:rounded-full">
            <Link
              key={index}
              href={phone.url}
            >
